...
description: Legacy ticket flow retained for existing projects
---

<Callout type="warn">
Ticket Blueprint nodes are deprecated for new client matchmaking flows. Use [Group Up](/matchmaking/group-up) for new party, group, and solo matchmaking integrations.
</Callout>
...
`CreateGroupTicket` is deprecated. Use [Group Up](/matchmaking/group-up) for party and group matchmaking flows instead.
